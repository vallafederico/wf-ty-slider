(() => {
  ...
  function t(n2, t2, i2) {
    if (i2 || 2 === arguments.length)
      for (var e2, r2 = 0, a2 = t2.length; r2 < a2; r2++)
        (!e2 && r2 in t2) ||
          (e2 || (e2 = Array.prototype.slice.call(t2, 0, r2)),
          (e2[r2] = t2[r2]));
  ...
  function o(n2, t2) {
    return (
      ...
      Array.isArray(n2)
        ? n2
        : "string" == typeof n2
        ? i(t2.querySelectorAll(n2))
        : n2 instanceof HTMLElement
        ? [n2]
        : n2 instanceof NodeList
        ? i(n2)
        : []
    );
  }
    ...
    return {
      ...
      purge: function () {
        n2.forEach(function (n3) {
          n3[0].removeListener
            ? n3[0].removeListener(n3[2])
            : n3[0].removeEventListener(n3[1], n3[2], n3[3]);
        }),
          (n2 = []);
      },
    };
  ...
  function h(n2) {
    ...
    function u2(t3) {
      ...
      var f2 = l3[2],
        p2 = l3[4],
        v2 = l3[0],
        h2 = l3[1] * (0, l3[5])(0 === p2 ? 1 : (a3 - f2) / p2);
          ...
          (i2 = 0),
            ...
            (r2 = t3.map(function (n3) {
              var t4,
                i3 = o3,
                r3 =
                  null !== (t4 = n3.earlyExit) && void 0 !== t4
                    ? t4
                    : n3.duration,
                u3 = n3.easing,
                s3 = n3.distance * u3(r3 / n3.duration) || 0;
              o3 += s3;
              var c3 = e2;
              return (
                (e2 += r3),
  ...
  function m(n2) {
    ...
    function z(n3) {
      ...
      var a3 = l(n3),
        o3 = c2.indexOf(
          t([], c2, true).reduce(function (n4, t2) {
      ...
      return (
        a3 < 0 && i3++,
        o3 === s2 && ((u3 = 0), (i3 += a3 > 0 ? 1 : -1)),
        { abs: u3 + i3 * s2 * a3, origin: o3, rel: u3 }
      );
    }
    function I(n3, t2, i3) {
      var e3;
      ...
      var c3 = A(u3 - s2 * l(o3));
      return (
        ((null !== c3 && Math.abs(c3) < Math.abs(e3)) || null === e3) &&
          (e3 = c3),
        v(e3)
      );
    }
    ...
    function _(t2) {
      var i3;
      (i3 = t2 - T),
        w.push({ distance: i3, timestamp: r() }),
            ...
            if (s2) {
              var n3 = S(),
                ...
                y3 = u2.map(function (t4, i4) {
                  var a3 = r3 + c3;
                  (a3 < 0 - t4[0] || a3 > 1) &&
                    (a3 += (Math.abs(a3) > e2 - 1 && n3 ? e2 : 0) * l(-a3));
                  var u3 = i4 - p2,
                    d3 = l(u3),
                    h3 = u3 + f3;
                  n3 &&
            ...
            function (t3, i3) {
              ...
              return (
                n3 - r2 > 200 ||
                  (l(e3) !== l(t3.distance) &&
                    t3.distance &&
                    (t3 = { distance: 0, lastTimestamp: 0, time: 0 }),
    ...
    function h2() {
      ...
      if (e3 || !t3) {
        ...
        if (y2 < a2 || y2 > o2) {
          ...
          var z = m2(T, 100),
            I = z.dist * r2;
          n2.options.rubberband &&
            (s3.push({ distance: I, duration: c2(z.dur), easing: p2 }),
            s3.push({ distance: -I + M, duration: 500, easing: p2 }));
        }
      ...
      if ((C.purge(), n2.options.drag && !n2.options.disabled)) {
        ...
        (i3 = n2.options.dragSpeed || 1),
          ...
          (function () {
            ...
            o("[".concat(n3, "]:not([").concat(n3, "=false])"), t2).map(
              function (n4) {
          ...
          C.input(t2, "touchstart", z, { passive: true }),
          C.input(t2, "touchmove", E, { passive: false }),
        ...
        o("[".concat(r3, "]:not([").concat(r3, "=false])"), n2.container).map(
          function (n3) {
            return (function (n4) {
              var t3;
              C.input(
                ...
                C.input(n4, "touchmove", function (i4) {
                  var e3 = L(),
                    r4 = e3
                      ? n4.scrollHeight - n4.clientHeight
                      : n4.scrollWidth - n4.clientWidth,
                    a3 = t3 - D(i4),
                    o2 = e3 ? n4.scrollTop : n4.scrollLeft,
                    s2 =
                      (e3 && "scroll" === n4.style.overflowY) ||
                      (!e3 && "scroll" === n4.style.overflowX);
                  if (
                    ((t3 = D(i4)),
  ...
  function x(n2) {
    ...
    function f2() {
      d2(),
        ...
        n2.options.disabled ||
          "custom" === n2.options.renderMode ||
          ((e2 = "auto" === p(n2.options.slides, "perView", null)),
    ...
    return function (e2) {
      ...
      function m2(n2) {
        ...
        a(
          ...
          "rtl" !==
            ((t3 = e2.container),
            window.getComputedStyle(t3, null).getPropertyValue("direction")) ||
            n2
            ? null
            : ""
        ),
      ...
      function C() {
        ...
        for (
          var t3 = e2.slides,
            i3 = t3.length,
            r3 = "number" == typeof n2 ? n2 : p(n2, "number", i3, true),
            a2 = [],
            o2 = p(n2, "perView", 1, true),
            u3 = p(n2, "spacing", 0, true) / e2.size || 0,
            s3 = "auto" === o2 ? u3 : u3 / o2,
            c2 = p(n2, "origin", "auto"),
            d3 = 0,
            l3 = 0;
      ...
      (e2.container = (v2 = o(t2, l2 || document)).length ? v2[0] : null),
        (e2.destroy = function () {
        ...
        return (
          ...
          (function () {
            if (((i3.track = m(i3)), (i3.animator = h(i3)), t2))
              for (var n4 = 0, e4 = t2; n4 < e4.length; n4++) (0, e4[n4])(i3);
  ...
  var slider_default = class {
    ...
    config(config) {
      if (this.element.dataset.duration) this.element.dataset.duration *= 1e3;
  ...
  // src/app.js
  var initAttribute = document.querySelector("[data-no-init]");
  if (!initAttribute) {
    const el = [...document.querySelectorAll("[data-slider='wrapper']")];
    el.forEach((wrapper) => new slider_default(wrapper));
  }
  window.Slider = slider_default;
})();
